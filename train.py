...
def get_data(tokenizer, max_length, args):
    ...
    if args.ablation_visual:
        train_dataset =  AblationFeaturesDataset(
                            ...
                            it2_features_path=os.path.join(args.i2t_features_dir,'train.hdf5'),
                            tokenizer=tokenizer,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--i2t_features_dir", type=str, default="i2t_features/", help="Directory where cached input image features are stored")
